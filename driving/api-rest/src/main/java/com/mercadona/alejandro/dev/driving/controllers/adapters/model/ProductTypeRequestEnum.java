...
/**
 * Gets or Sets ProductTypeRequestEnum
 */
...
public enum ProductTypeRequestEnum {
  ...
  ProductTypeRequestEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ProductTypeRequestEnum fromValue(String value) {
    for (ProductTypeRequestEnum b : ProductTypeRequestEnum.values()) {
