...
public class CursorPagination {
  ...
  public CursorPagination requestedSize(@Nullable Integer requestedSize) {
  ...
  public CursorPagination retrievedResults(@Nullable Integer retrievedResults) {
  ...
  public CursorPagination nextPage(@Nullable String nextPage) {
  ...
  public CursorPagination previousPage(@Nullable String previousPage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestedSize, cursorPagination.requestedSize) &&
        Objects.equals(this.retrievedResults, cursorPagination.retrievedResults) &&
        Objects.equals(this.nextPage, cursorPagination.nextPage) &&
        Objects.equals(this.previousPage, cursorPagination.previousPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestedSize, retrievedResults, nextPage, previousPage);
  }
